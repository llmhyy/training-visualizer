...
<div class="container">
  ...
  <div data-panel="advanced" class="ink-panel-content query-content">
    ...
    <div style="display:flex;">
      <paper-input style="width: 90px; margin-right:10px;" value="{{suggestKNum}}" label="k number"></paper-input>
      <button style="width: 100px;" class="bounding-selection search-button search">Select</button>
      <button style="width: 100px;" class="query-suggestion search-button search">Suggest</button>
    </div>
    <div style="display:flex;">
